...
/// <reference path="./lib/addons/p5play.d.ts" />
...
declare global {
 ...
 function decodeFloat16(b: any): number;
 function isArrowFunction(fn: any): boolean;
/** 
 ...
 */
 function isColliderType(t: string): boolean;
/**
 ...
 */
 function getRegularPolygon(l: number, n: string): any[];
/**
 * @private
 * @param {*} e keyboard event
 * @returns key name
 */
 function _getKeyFromCode(e: any): any;
 let pInst: any;
 const log: (...data: any[]) => void;
 const pl: any;
 const plScale: 60;
 function scaleTo(x: any, y: any, tileSize: any): any;
 function scaleXTo(x: any, tileSize: any): number;
 function scaleFrom(x: any, y: any, tileSize: any): any;
 function scaleXFrom(x: any, tileSize: any): number;
 function isSlop(val: any): boolean;
 function fixRound(val: any): any;
 namespace eventTypes {
    let _collisions: string[];
    let _overlappers: string[];
}
/**
 * @typedef {any} planck
 * @typedef {any} planck.Vec2
 * @typedef {any} planck.Body
 * @typedef {any} planck.Fixture
 * @typedef {any} planck.World
 * @typedef {any} planck.Contact
 */
/**
 * @class
 */
 class Sprite {
    ...
    _shift: {};
    _massUndef: boolean;
    _dimensionsUndef: boolean;
    _widthUndef: boolean;
    _heightUndef: boolean;
    /**
     ...
     */
    get density(): number;
    _getDirectionAngle(name: any): any;
 ...
 class SpriteAnimation extends Array<any> {
     ...
     * @type {Array<Image>}
     */
    get images(): (new (width?: number, height?: number) => HTMLImageElement)[];
}
/**
 ...
 */
 ...
 class Group extends Array<any> {
    ...
    _resetDistancesFromCentroid(): void;
    _ensureCollide(target: any, callback: any): void;
    collide(target: any, callback: any): boolean;
    /**
 ...
 class World {
     ...
     */
    getSpritesAt(x: number, y: number, group?: Group, cameraActiveWhenDrawn?: boolean): Array<Sprite>;
    /**
 ...
 class Camera {
     ...
     */
    get position(): any;
    _calcBoundsX(val: any): void;
    _calcBoundsY(val: any): void;
    set zoom(arg: number);
    /**
     * Camera zoom.
     *
 ...
 class Joint {
     ...
     */
    visible: boolean;
    _createJoint(j: any): void;
    _j: any;
    _display(): void;
    _draw(xA: any, yA: any, xB: any, yB: any): void;
    set draw(arg: () => void);
    /**
...
//@ts-ignore
 function play(sound: p5.Sound): Promise<any>;
...
//  var camera: Camera;
 ...
 class _Contros extends Array<any> {
    ...
    constructor();
    default: string;
    _addContro(gp: any): void;
    _removeContro(gp: any): void;
    /**
